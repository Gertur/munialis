                        ...
                        <div className="col-12 ml-2">
                            <div className="row">
                                <div className="col-9">
                                    ...
                                    <ul className="h4 list-unstyled ml-3">
                                        ...
                                        <li><i class="fas fa-check-circle mr-2" style={{ fontSize: '18px' }}></i>Certificado de solteria o viudez.
                                    </li>
                                ...
                                <div className="col-3">
                                    <div className="card h5 mr-2">
                                        <div className="card-body">
                                            ...
                                            <p className="card-text"><i class="fas fa-calendar-week mr-2"></i>Lunes a Viernes de 9:00 am a 1:00 pm</p>
                                            <p className="card-text"><i class="fas fa-calendar-week mr-2"></i>Lunes a Viernes de 3:00 pm a 7:00 pm</p>
                                            <p className="card-text"><i class="fas fa-calendar-week mr-2"></i>Informes e inscripciones: Municipalidad Distrital de Alis, 3er Piso.</p>
                                            <p className="card-text"><i class="fas fa-user mr-2"></i>Registrador Civil: Arturo Huaraca Espejo.</p>
                                            <p className="card-text"><i className="fas fa-phone-square-alt mr-2"></i>966873728</p>
                                            <p className="card-text"><i class="fas fa-envelope mr-2"></i>gerturh@gmail.com</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-12">
                                    ...
                                    <ul className="h4 list-unstyled ml-3">
                                        <li><i class="fas fa-check-circle mr-2" style={{ fontSize: '18px' }}></i>Presentarse ambos contrayentes en la oficina de Registro Civil de la Municipalidad Distrital de Alis, con la documentación completa.
                                        </li>
                                        <li><i class="fas fa-check-circle mr-2" style={{ fontSize: '18px' }}></i>Abrir el expediente Matrimonial, previa revisión, calificación de documentos y pago del derecho de trámite.
                                        </li>
                                        <li><i class="fas fa-check-circle mr-2" style={{ fontSize: '18px' }}></i>Una vez calificado positivamente el Expediente Matrimonial se hára entrega del Edicto Matrimonial para su publicación en el diario de mayor circulación nacional, o en todo caso en los murales de la Municipalidad del Distrito en el que residen.
                                        </li>
                                        <li><i class="fas fa-check-circle mr-2" style={{ fontSize: '18px' }}></i>Una vez publicado el edicto matrimonial, estarán aptos  para contraer matrimonio a partir del noveno día.
                                        </li>
                                        <li><i class="fas fa-check-circle mr-2" style={{ fontSize: '18px' }}></i>Luego de publicado el edicto, el mismo debe ser devuelto para las cordinaciones de la ceremonia.
                                        </li>
                                    </ul>
                                </div>
                            </div>
