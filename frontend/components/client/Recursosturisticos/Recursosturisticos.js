                                    ...
                                    <div className="row">
                                        <div className="col-4">
                                            <article className="recursoturisticocard pr-0 pl-0">
                                                <img className="recursoturisticocard__img" src="./img/cultura-alis.jpg" alt="" height="350px"/>
                                        ...
                                        <div className="col-4">
                                            <article className="recursoturisticocard pr-0 pl-0">
                                                ...
                                                <strong className="recursoturisticocard__like__title">Los andesnes de Huacta<i class="fas fa-heart ml-4">12</i></strong>
                                                <i class="recursoturisticocard__info fas fa-info-circle fas-2s"></i>
                                            </article>
                                        </div>
                                        <div className="col-4">
                                            <article className="recursoturisticocard pr-0 pl-0">
                                                ...
                                                <strong className="recursoturisticocard__like__title">Sitio Arqueológico de Coricoto<i class="fas fa-heart ml-4">12</i></strong>
                                                <i class="recursoturisticocard__info fas fa-info-circle fas-2s"></i>
                                            </article>
                                        </div>
                                    </div>
                                    ...
                                    <div className="row">
                                        <div className="col-4">
                                            <article className="recursoturisticocard pr-0 pl-0">
                                                ...
                                                <strong className="recursoturisticocard__like__title">Bosque de lloque<i class="fas fa-heart ml-4">12</i></strong>
                                                <i class="recursoturisticocard__info fas fa-info-circle fas-2s"></i>
                                            </article>
                                        </div>
                                        <div className="col-4">
                                            <article className="recursoturisticocard pr-0 pl-0">
                                                ...
                                                <strong className="recursoturisticocard__like__title">Cañon de Uchco<i class="fas fa-heart ml-4">12</i></strong>
                                                <i class="recursoturisticocard__info fas fa-info-circle fas-2s"></i>
                                            </article>
                                        </div>
                                        <div className="col-4">
                                            <article className="recursoturisticocard pr-0 pl-0">
                                                ...
                                                <strong className="recursoturisticocard__like__title">Catarata de Tapo<i class="fas fa-heart ml-4">12</i></strong>
                                                <i class="recursoturisticocard__info fas fa-info-circle fas-2s"></i>
                                            </article>
                                        </div>
                                    </div>
                                    ...
                                    <div className="row">
                                        <div className="col-4">
                                            <article className="recursoturisticocard pr-0 pl-0">
                                                ...
                                                <strong className="recursoturisticocard__like__title">Catarata Caida del Ángel<i class="fas fa-heart ml-4">12</i></strong>
                                                <i class="recursoturisticocard__info fas fa-info-circle fas-2s"></i>
                                            </article>
                                        </div>
                                        <div className="col-4">
                                            <article className="recursoturisticocard pr-0 pl-0">
                                                ...
                                                <strong className="recursoturisticocard__like__title">La cueva de los Muriciélagos<i class="fas fa-heart ml-4">12</i></strong>
                                                <i class="recursoturisticocard__info fas fa-info-circle fas-2s"></i>
                                            </article>
                                        </div>
                                        <div className="col-4">
                                            <article className="recursoturisticocard pr-0 pl-0">
                                                <img className="recursoturisticocard__img" src="./img/cultura-alis.jpg" alt="" height="350px"/>
                                                <div className="recursoturisticocard__content">
                                                    <h3 className="recursoturisticocard__title">Museo Municipal</h3>
                                                    <p className="h4 text-justify">Situado en la parte alta del distrito de alis</p>
                                                </div>
                                                <strong className="recursoturisticocard__like__title">Catarata de Tapo<i class="fas fa-heart ml-4">12</i></strong>
                                                <i class="recursoturisticocard__info fas fa-info-circle fas-2s"></i>
